...
/***/ function(module, exports, __webpack_require__) {
	...
	_socket.connections$.subscribe(function (client) {
	    console.log('Clients update', client);
	});
	
	function main(responses) {
	    var USERS_URL = 'http://jsonplaceholder.typicode.com/users/';
	    var getRandomUser$ = responses.DOM.select('.get-random').events('click').map(function () {
	    ...
	    var user$ = responses.HTTP.filter(function (res$) {
	    ...
	    var vtree$ = user$.map(function (user) {
	        return (0, _dom.h)('div.users', [(0, _dom.h)('button.get-random', 'Get Another random user'), user === null ? null : (0, _dom.h)('div.user-details', [(0, _dom.h)('h1.user-name', user.name), (0, _dom.h)('h4.user-email', user.email), (0, _dom.h)('a.user-website', { href: user.website }, user.website)])]);
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.connections$ = exports.uiConnection$ = undefined;
	...
	var CLIENT_CONNECTIONS = 'ui:client:connection';
	var UI_CONNECTIONS = 'connection';
	
	function socket() {
	    return window.___browserSync___.socket;
	};
	
	var uiConnection$ = exports.uiConnection$ = _rx2.default.Observable.fromEvent(socket(), UI_CONNECTIONS);
	
	var connections$ = exports.connections$ = _rx2.default.Observable.fromEvent(socket(), CLIENT_CONNECTIONS).skipUntil(uiConnection$).take(1);

/***/ }
/******/ ]);
//# sourceMappingURL=app.cycle.js.map