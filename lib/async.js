...
module.exports = {
    ...
    addElementEvents: function (cp, done) {
        ...
        bs.setOption("clientFiles", Immutable.fromJS(elems));
            ...
            instance: {
                enableElement:  require("./client-elements").enable(cp.clients, cp, bs),
                addElement:     require("./client-elements").addElement,
                disableElement: require("./client-elements").disable(cp.clients, cp, bs)
            }
        });
    }
};