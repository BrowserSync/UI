...
app.controller("MainCtrl", ["$scope", "$rootScope", "$route", "$location", "Socket", "$injector", "$q", MainCtrl]);
 ...
 * @constructor
 */
function MainCtrl ($scope, $rootScope, $route, $location, Socket, $injector, $q) {
...
/* jshint ignore:end */
},{"./MainCtrl":1,"./modules/disconnect":4,"./modules/history":5,"./modules/notify":6,"./modules/socket":7,"./services/ContentSections":8}],3:[function(require,module,exports){
"use strict";
