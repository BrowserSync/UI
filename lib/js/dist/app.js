...
},{"./module":5}],2:[function(require,module,exports){
...
/* jshint ignore:end */
},{"./MainCtrl":1,"./filters":4,"./modules/clients":6,"./modules/disconnect":7,"./modules/history":8,"./modules/notify":9,"./modules/socket":10,"./services/ContentSections":11,"./services/Options":12}],4:[function(require,module,exports){
...
},{"./directives/icon":2,"./module":5}],5:[function(require,module,exports){
"use strict";
...
angular.module("Disconnect", [])
    ...
    .directive("disconnectElem", function () {
        ...
        return {
            restrict: "E",
            scope: {},
            template: '<section bs-overlay class="active" ng-class="{\'active\': ui.visible}"><p><icon icon="block"></icon></p><h1>{{ui.heading}} {{ui.message}}</h1><p>Possible reasons are:</p><ul bs-list><li>1. Your process was exited by another tool</li></ul></section>', // jshint:ignore
...
},{"../module":5}],12:[function(require,module,exports){
/**
 * @type {angular}
 */
var app = require("../module");
