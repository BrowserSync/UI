...
app.controller("MainController", ["$scope", "$rootScope", "$location", "Socket", "$injector", MainCtrl]);
...
/* jshint ignore:end */
},{"./MainCtrl":1,"./filters":4,"./modules/disconnect":6,"./modules/history":7,"./modules/notify":8,"./modules/socket":9,"./services/ContentSections":10,"./services/Options":11}],4:[function(require,module,exports){
...
},{"../module":5}],11:[function(require,module,exports){
/**
 * @type {angular}
 */
var app = require("../module");
