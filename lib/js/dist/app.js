    ...
    return {
        ...
        controller: function ($scope, Socket) {
            ...
            $scope.toggle = function (key, value) {
                var newValue = !value;
                Socket.emit("urls:option:set", {key: prefixOption(key), value: newValue});
            };
            ...
            $scope.formToggle = function (item) {
                ...
                Socket.emit("urls:option:set", {key: prefixOption(item.key), value: newValue});
            };
...
},{"../module":9,"../utils":13}],6:[function(require,module,exports){
/**
 * @type {angular}
 */
var app       = require("../module");
...
},{"../module":9,"../utils":13}],7:[function(require,module,exports){
/**
 * @type {angular}
 */
...
function urlSyncController($scope, $rootScope, Socket) {
    ...
    Socket.addEvent("urls:urls:update", $scope.updateVisited);
}
...
/* jshint ignore:start */
var module      = angular.module("BrowserSync", ["Notify", "Socket"]);
...
/* jshint ignore:end */
},{"./controllers":2,"./directives":3,"./modules/notify":10,"./modules/socket":11,"./services":12}],9:[function(require,module,exports){
"use strict";
