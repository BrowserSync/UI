...
app.controller("MainCtrl", ["$scope", "$rootScope", "Options", "$location", "Socket", "$injector", MainCtrl]);
 ...
 * @constructor
 */
function MainCtrl ($$scope, $rootScope, Options, $location, Socket, $injector) {
...
/* jshint ignore:start */
var module      = angular.module("BrowserSync", ["History", "Disconnect", "Notify", "Socket", "ngOrderObjectBy", "ngRoute"]);
...
/* jshint ignore:end */
},{"./MainCtrl":1,"./modules/disconnect":4,"./modules/history":5,"./modules/notify":6,"./modules/socket":7,"./services/ContentSections":8,"./services/Options":9}],3:[function(require,module,exports){
"use strict";
