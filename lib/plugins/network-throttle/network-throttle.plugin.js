...
var latency = require("./latency/latency");
...
module.exports = {
    ...
    "plugin": function (ui, bs) {
        ...
        ui.latency = latency.init(ui, bs);
        ui.listen("network-throttle:latency", ui.latency);
    },
    ...
    "hooks": {
        ...
        "client:js": [
            fileContent("/network-throttle.client.js"),
            fileContent("/latency/latency.client.js")
        ],
        "templates": [
            getPath("/latency/latency.html")
        ],
        "page": {
