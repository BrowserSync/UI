...
module.exports = {
    ...
    "plugin": function (ui, bs) {
        ...
        ui.listen("plugins", {
            ...
            "set": function (data) {
                ui.bsPlugins = ui.bsPlugins.map(function (plug) {
                    if (plug.getIn(['module', 'plugin:name']) === data.module['plugin:name']) {
                        return plug.set('active', data.active);
                    }
                    return plug;
                });
                bs.plugin('plugins:configure', data);
            },
